...
.field public static final NEWBEE_RESOURCE_COOKIE_NOT_INITIALED:I = -0x2

.field public static final NEWBEE_RESOURCE_COOKIE_NOT_INITIALED_FAILED:I = -0x1
...
.field newbeemFrameworkResourceCookie:I

.field newbeemPackageName:Ljava/lang/String;

.field newbeemThemeResourceCookie:I
...
.method public constructor <init>()V
    ...
    iput v3, p0, Landroid/content/res/AssetManager;->mNumRefs:I

    iput-boolean v3, p0, Landroid/content/res/AssetManager;->mOpen:Z

    iput v2, p0, Landroid/content/res/AssetManager;->newbeemFrameworkResourceCookie:I

    iput v2, p0, Landroid/content/res/AssetManager;->newbeemThemeResourceCookie:I
    ...
    const-string v0, "/system/framework/framework-newbee-res.apk"

    .local v0, newbeeFrameworkResPath:Ljava/lang/String;
    ...
    .end local v0           #newbeeFrameworkResPath:Ljava/lang/String;
    :catchall_0
    move-exception v1
...
.method private declared-synchronized NewbeeOpenFrameResource()V
    .locals 1
    ...
    :try_start_0
    iput v0, p0, Landroid/content/res/AssetManager;->newbeemFrameworkResourceCookie:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final decRefsLocked(I)V
    ...
    .line 792
    invoke-virtual {p0}, Landroid/content/res/AssetManager;->NewbeeCloseZipResource()V
...
# virtual methods
.method public NewbeeCloseZipResource()V
    .locals 0
...
.method NewbeeDelayInitial()V
    ...
    .line 826
    iget v1, p0, Landroid/content/res/AssetManager;->newbeemFrameworkResourceCookie:I
    ...
    invoke-static {v1}, Landroid/content/res/TxZipResources;->getZipFile(Ljava/lang/String;)Ljava/io/File;
    ...
    iput v1, p0, Landroid/content/res/AssetManager;->newbeemFrameworkResourceCookie:I

    .line 834
    .end local v0           #file:Ljava/io/File;
    :cond_0
    iget v1, p0, Landroid/content/res/AssetManager;->newbeemThemeResourceCookie:I

    if-ne v1, v3, :cond_1

    iget-object v1, p0, Landroid/content/res/AssetManager;->newbeemPackageName:Ljava/lang/String;
    ...
    iput v1, p0, Landroid/content/res/AssetManager;->newbeemThemeResourceCookie:I
...
.method NewbeeLoadPic(Ljava/lang/String;I)I
    .locals 3
    .parameter "fileName"
    ...
    .line 847
    invoke-virtual {p0}, Landroid/content/res/AssetManager;->NewbeeDelayInitial()V

    .line 849
    iget v2, p0, Landroid/content/res/AssetManager;->newbeemThemeResourceCookie:I
    ...
    invoke-direct {p0, v2, p1, p2}, Landroid/content/res/AssetManager;->openNonAssetNative(ILjava/lang/String;I)I
    :try_end_0
    ...
    iget v2, p0, Landroid/content/res/AssetManager;->newbeemFrameworkResourceCookie:I
...
.method public declared-synchronized NewbeeOpenZipResources(Ljava/lang/String;)V
    .locals 1
    ...
    :try_start_0
    iput v0, p0, Landroid/content/res/AssetManager;->newbeemThemeResourceCookie:I

    .line 806
    iput-object p1, p0, Landroid/content/res/AssetManager;->newbeemPackageName:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public NewbeeReOpenZipResource()V
    .locals 1

    .prologue
    .line 818
    iget-object v0, p0, Landroid/content/res/AssetManager;->newbeemPackageName:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Landroid/content/res/AssetManager;->NewbeeOpenZipResources(Ljava/lang/String;)V

    .line 820
    :cond_0
    invoke-direct {p0}, Landroid/content/res/AssetManager;->NewbeeOpenFrameResource()V
...
.method public openNonAsset(ILjava/lang/String;I)Ljava/io/InputStream;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {p0, p2, p3}, Landroid/content/res/AssetManager;->NewbeeLoadPic(Ljava/lang/String;I)I
