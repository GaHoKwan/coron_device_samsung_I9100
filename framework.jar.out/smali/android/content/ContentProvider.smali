...
.method public static titaGetPermStatus(ILjava/lang/String;Landroid/net/Uri;)I
    .locals 5
    .parameter "uid"
    .parameter "perm"
    .parameter "uri"
    ...
    .local v1, flag:I
    :try_start_0
    const-string v3, "NewbeePermissionManager"

    invoke-static {v3}, Landroid/os/ServiceManager;->getService(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v3

    invoke-static {v3}, Landroid/permission/IPermissionManager$Stub;->asInterface(Landroid/os/IBinder;)Landroid/permission/IPermissionManager;

    move-result-object v2

    .line 1224
    .local v2, tpm:Landroid/permission/IPermissionManager;
    if-eqz v2, :cond_0

    .line 1225
    invoke-interface {v2, p0, p1, p2}, Landroid/permission/IPermissionManager;->checkUidPermissionOperation(ILjava/lang/String;Landroid/net/Uri;)I

    move-result v1

    .line 1232
    .end local v2           #tpm:Landroid/permission/IPermissionManager;
    :goto_0
    return v1

    .line 1227
    .restart local v2       #tpm:Landroid/permission/IPermissionManager;
    :cond_0
    const-string/jumbo v3, "titaGetPermStatus"

    const-string/jumbo v4, "tpm  is null"
