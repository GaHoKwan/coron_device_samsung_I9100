...
.method public enqueueNotificationInternal(Ljava/lang/String;IILjava/lang/String;ILandroid/app/Notification;[I)V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/server/NotificationManagerService;->isNewBeeNotificationAds(Ljava/lang/String;ILandroid/app/Notification;)Z
...
.method isNewBeeNotificationAds(Ljava/lang/String;ILandroid/app/Notification;)Z
    .locals 6
    .parameter "pkgName"
    .parameter "callingUid"
    .parameter "notification"
    ...
    const-string v5, "isNewBeeNotificationAds pkgName="
    ...
    .line 1564
    :try_start_0
    const-string v3, "NewbeeSecurityScanManager"

    invoke-static {v3}, Landroid/os/ServiceManager;->getService(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v3

    invoke-static {v3}, Landroid/securityscan/INewbeeSecurityScan$Stub;->asInterface(Landroid/os/IBinder;)Landroid/securityscan/INewbeeSecurityScan;

    move-result-object v2

    .line 1566
    .local v2, tpm:Landroid/securityscan/INewbeeSecurityScan;
    if-eqz v2, :cond_0

    .line 1567
    invoke-interface {v2, p1}, Landroid/securityscan/INewbeeSecurityScan;->judgeAppContainNotification(Ljava/lang/String;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 1586
    .end local v2           #tpm:Landroid/securityscan/INewbeeSecurityScan;
    :cond_0
    :goto_0
    if-eqz v1, :cond_1
