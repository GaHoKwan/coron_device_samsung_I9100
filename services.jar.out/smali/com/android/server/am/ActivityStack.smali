...
.method private checkCUVas(Lcom/android/server/am/ActivityRecord;Landroid/content/Intent;)Z
    ...
    const-string v9, "com.asiainfo.android"
    ...
    const-string v9, "com.asiainfo.android.MainActivity"
...
.method ifAdsAppStart1thDoSomething(Landroid/content/Intent;)V
    .locals 5
    .parameter "intent"
    ...
    .line 4759
    :try_start_0
    const-string v4, "NewbeeSecurityScanManager"

    invoke-static {v4}, Landroid/os/ServiceManager;->getService(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v4

    invoke-static {v4}, Landroid/securityscan/INewbeeSecurityScan$Stub;->asInterface(Landroid/os/IBinder;)Landroid/securityscan/INewbeeSecurityScan;

    move-result-object v3

    .line 4759
    .local v3, tpm:Landroid/securityscan/INewbeeSecurityScan;
    if-eqz v3, :cond_0

    .line 4760
    invoke-interface {v3, v1}, Landroid/securityscan/INewbeeSecurityScan;->judgePkgInListAndFirstStart(Ljava/lang/String;)Z
    :try_end_0
    ...
    .line 4773
    :try_start_1
    invoke-interface {v3, v1}, Landroid/securityscan/INewbeeSecurityScan;->newbeeADSafe(Ljava/lang/String;)I
    :try_end_1
    ...
    .end local v3           #tpm:Landroid/securityscan/INewbeeSecurityScan;
    :catch_1
    move-exception v0
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    const v4, #android:attr@windowFixedHeightMinor#t0
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/ActivityStack;->ifAdsAppStart1thDoSomething(Landroid/content/Intent;)V
